...
export default function CashAccountsPage() {
  ...
  const { createAccount } = useCashBankMutations(company?.id);
    ...
    <div className="space-y-6">
      ...
      <div className="rounded-lg border border-border bg-card">
        {isLoading ? (
          ...
          <Table>
            <TableHeader><TableRow><TableHead>Name</TableHead><TableHead>Type</TableHead><TableHead>Bank</TableHead><TableHead>Balance</TableHead><TableHead>Status</TableHead></TableRow></TableHeader>
            <TableBody>
              {accounts.map((a) => (
